        ...
        <div className="space-y-6">
          ...
          <Card className="bg-card/80 backdrop-blur border-border/20">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <span className="text-muted-foreground">Public Progress</span>
              ...
              <div className="flex items-center justify-between">
                <span className="text-muted-foreground">Public Achievements</span>
          ...
          <div className="text-center">
            <p className="text-muted-foreground mb-4">Want to update your profile?</p>
